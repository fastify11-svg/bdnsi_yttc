<x-admin-app-layout>
    ...
    <form action="{{ route('admin.subject.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex flex-wrap justify-center w-full bg-white p-6 rounded-xl shadow">
            ...
            <x-label-input name="name" label="Course Name" required class="w-full sm:w-1/2 p-2"/>
            <x-label-input name="code" label="Course Code" class="w-full sm:w-1/2 p-2"/>
            <x-labeled-input name="duration" label="Duration (e.g. 6 Months)" class="w-full sm:w-1/2 p-2"/>
            <x-labeled-input name="rate" label="Course Fee/Rate (৳)" class="w-full sm:w-1/2 p-2"/>
            <x-labeled-input name="education_qualification" label="Education Qualification" class="w-full sm:w-1/2 p-2"/>
            ...
            <x-labeled-textarea name="course_details" label="Course Details/Description" class="w-full p-2"></x-labeled-textarea>
            ...
            <div class="w-full p-2">
                ...
                <div id="photo_preview_container" class="mt-3 hidden">
                    <img id="photo_preview" src="" alt="Preview" class="w-32 h-32 object-cover rounded-lg border shadow-sm"/>
                </div>
            </div>

            <div class="w-full py-6 flex justify-center">
                <x-button class="bg-[#7024A8] hover:bg-purple-800 text-white font-bold px-8 py-3 rounded-xl">{{ __('Create Course') }}</x-button>
            </div>
        </div>
    </form>
    <x-slot name="script">
